...
func (in *ControllerInterface) DeepCopyInto(out *ControllerInterface) {
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControllerInterface.
func (in *ControllerInterface) DeepCopy() *ControllerInterface {
	if in == nil {
		return nil
	}
	out := new(ControllerInterface)
	in.DeepCopyInto(out)
	return out
}
